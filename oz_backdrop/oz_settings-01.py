...
def Oz_BackdropPreferencesCallback():
    ...
    try:
        ...
        # Agregar un Boolean_Knob para el color de fondo
        k = nuke.Boolean_Knob("Oz_Backdrop_toggle_color", "Default background color white")
        k.setFlag(nuke.ALWAYS_SAVE)
        p.addKnob(k)
        k.setTooltip("If enabled, the default background color will be white, otherwise black.")
