"""Pull nodes up or down to make space in the DAG."""
...
def pull(
    ...
    """Pull nodes around selection to create empty space in DAG.
    ...
    Args:
        ...
        down (bool, optional): If True (default: False), pull nodes below up.
        up (bool, optional): If True (default: False), pull nodes above down.
        left (bool, optional): If True (default: False), pull nodes right.
        right (bool, optional): If True (default: False), pull nodes left.
    ...
    nuke.Undo.begin('Pull Nodes')  # Iniciar el grupo de deshacer
